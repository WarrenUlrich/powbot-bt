...
class Parallel(
    private val successPolicy: Policy = Policy.REQUIRE_ALL, private val failurePolicy: Policy = Policy.REQUIRE_ONE
) : Composite("Parallel") {
